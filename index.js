...
console.log('KareninAlani', KareninAlani(10));
...
console.log('CemberinCevresi',CemberinCevresi(5));
...
console.log('CemberinAlani',CemberinAlani(15,pi));

console.log('sayilar',sayilar[1]);
/* 	GÖREV 3:
...
/*  (oto test yok) sayilar dizisi içinde kaç adet sayı olduğunu konsola yazdırın */
	...
	console.log('1. Sayi Adeti',sayilar.length);
	
	//ikinci deneme
	// let sayiAdeti1=0;
	// for (let i=0;i<sayilar.length;i ++){
	// 	if(typeof (sayilar[i]= Number )){
	// 		sayiAdeti1 ++;
	// 	};
	// }
	
	// console.log('2. Sayi Adeti w/for',sayiAdeti1)
	
	//Ucuncu deneme

	// let sayiAdeti2 = 0;
	// for (let i=0;i<sayilar.length;i ++){
	// 	typeof (sayilar[i]=== Number) ? sayiAdeti2 ++ :sayiAdeti2;
	// }

	// console.log('3. Sayi Adeti w/kisaIF',sayiAdeti2)
	...
	// 	 }return enkucuk;
	// 	}
	// console.log('3a En Buyuk Sayi',largest());
	// console.log('3a En Ekucuk Sayi',smallest());
	...
	console.log('3a En Buyuk Sayi',enbuyuk);
	console.log('3a En Kucuk Sayi',enkucuk);

	// Deneme 3 --------- Olmasi sorarmisin?????
	//	let enBuyukSayi;
	//for (let i=0; i<sayilar.length; i++){
	// enBuyukSayi = enbuyuk>sayilar[i] ? enbuyuk : sayilar[i];
	//}
	// for (let i=0; i<sayilar.length; i++){
	//  let enKucukSayi = enkucuk<sayilar[i] ? enkucuk : sayilar[i];
	// }

	//console.log('3a En Buyuk Sayi',enBuyukSayi);
	// console.log('3a En Ekucuk Sayi',enKucukSayi);
	...
	// //Deneme 1
	// sayilar.forEach(sayilar3 => {
	// 	if(sayilar3 % 3===0){
	// 		return ucetambolunenler.push(sayilar3);
	// 	}
	// });

	// console.log('3b Uce Tam Bolunenler',ucetambolunenler);

	//Deneme 2
	sayilar.forEach(sayilar3 => {
		sayilar3 % 3===0 ? ucetambolunenler.push(sayilar3) : null;
		}
	);
	...
	console.log('3e Sirali Sayilar',besyuzdenkucuksayilar);
